...
# 14 currency method / wallet address / verify by
...
func _ready():
	...
	$currency_logo.texture_normal = load("res://About/photos/currency/Dash (DASH).png")
	reset_time()
...
func set_currency_logo(id):
	match id:
		0:
			$currency_logo.texture_normal = load("res://About/photos/currency/bitcoin.png")
		1:
			$currency_logo.texture_normal = load("res://About/photos/currency/bitcoinCash.png")
		2:
			$currency_logo.texture_normal = load("res://About/photos/currency/Bitcoin Gold (BTG).png")
		3:
			$currency_logo.texture_normal = load("res://About/photos/currency/Dash (DASH).png")
		4:
			$currency_logo.texture_normal = load("res://About/photos/currency/DigiByte (DGB).png")
		5:
			$currency_logo.texture_normal = load("res://About/photos/currency/Dogecoin (DOGE).png")
		6:
			$currency_logo.texture_normal = load("res://About/photos/currency/Ethereum (ETH).png")
		7:
			$currency_logo.texture_normal = load("res://About/photos/currency/FIRO (FIRO).png")
		8:
			$currency_logo.texture_normal = load("res://About/photos/currency/Komodo (KMD).png")
		9:
			$currency_logo.texture_normal = load("res://About/photos/currency/Litecoin (LTC).png")
		11:
			$currency_logo.texture_normal = load("res://About/photos/currency/Ravencoin (RVN).png")
		12:
			$currency_logo.texture_normal = load("res://About/photos/currency/Vertcoin (VTC).png")
		13:
			$currency_logo.texture_normal = load("res://About/photos/currency/Zcash (ZEC).png")
